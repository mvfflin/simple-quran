...
const ReadQuran = ({
    ...
    const [surah, setSurah] = useState<Surah | null | undefined>({});
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="og:title"
                    content={`Surah ${surahMeta.namaLatin}`}
                />
                <meta
                    name="og:description"
                        ...
                        <>
                            {surah ? (
                                ...
                                <>
                                    ...
                                    <h2 className="text-xl">
                                        Mohon masukkan nomor surah yang benar di
                                        input URL
                                    </h2>
                                    <Link href="/read">
                                        <button className="btn mt-2">
                                            Kembali ke menu surah
                                        </button>
                                    </Link>
                                </>
                            )}

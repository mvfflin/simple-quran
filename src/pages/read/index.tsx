                        ...
                        {surahs?.map((surah: Surah, index: number) => {
                            return (
                                <a href={`/read/${surah.nomor}`} key={index}>
                                    <div className="dark:bg-neutral-800 bg-neutral-100 my-2 rounded-md p-5 w-auto md:w-96 mx-auto text-left hover:scale105 md:hover:scale-125 hover:shadow-md hover:rotate-6 hover:shadow-white transition-all">
